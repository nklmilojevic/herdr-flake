...
GITHUB_API_URL="https://api.github.com/repos/herdrdev/herdr/releases"
RELEASE_BASE_URL="https://github.com/herdrdev/herdr/releases/download"
...
get_latest_stable_version() {
  local headers=(-H "Accept: application/vnd.github+json" -H "User-Agent: herdr-flake-updater")
  ...
  # Stable releases only: upstream also publishes "preview-<date>-<sha>" tags
